...
class cmcompletedjson_comprule extends \local_coursegoals\comprule
{
...
//            }
    ...
    public static function getCompletionConditions($task = null)
    {
        if (!empty($task)) {
            ...
            return get_string('completioncondition', 'comprules_cmcompletedjson', $link);
        }
        return '';
    }
}