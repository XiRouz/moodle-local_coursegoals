...
class cmcompleteddb_form extends \local_coursegoals\comprule_form
{
    ...
    public static function getFormElementsGroup(&$mform)
    {
        ...
        $group[] = $mform->createElement('select', 'cmid',
            get_string('cmid', 'comprules_cmcompleteddb'), $cmOptions);
        // add help button?
        return $group;
    }
    ...
    public static function validateParams($params)
    {
        ...
        if (empty($params['cmid'])) {
            $errors['cmid'] = get_string('error:choose_cm', 'comprules_cmcompleteddb');
        }
        return $errors;
    }
