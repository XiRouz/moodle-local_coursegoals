...
class task_edit_form extends \core_form\dynamic_form {
    ...
    protected function definition()
    {
        ...
        $taskid = $this->optional_param('taskid', null, PARAM_INT);
        if ($taskid) {
            $task = new Task($taskid);
            $cgid = $task->coursegoalid;
        }
        ...
        $mform->addElement('select', 'sectionid', get_string('compruleid', 'local_coursegoals'), $sectionOptions);
