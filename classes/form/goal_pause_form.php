...
class goal_pause_form extends \core_form\dynamic_form {
    ...
    protected function definition()
    {
        ...
        $mform->addElement('static', 'confirm', '', get_string(Goal::ACTION_PAUSE.'_explained', 'local_coursegoals'));
    ...
    public function process_dynamic_submission() {
        $data = $this->get_data();
        list($result, $errors, $redirecturl) = api::pauseGoal($data);
        return [
            'result' => $result,
            'errors' => $errors,
